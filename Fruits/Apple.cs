...
/*
This class is responsible for Apple fruit game object logic
*/
public class Apple : MonoBehaviourPun
{
    ...
    // Triggers Apple's pulling, rescaling and destruction sequences 
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.gameObject.CompareTag("MFruitReducer"))
        {
            ...
            captureField.GetComponent<Transform>().localScale = new Vector3(0.3f, 0.3f, 0.3f);
        }
    }
